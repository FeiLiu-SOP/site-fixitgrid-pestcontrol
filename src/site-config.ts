/**
 * FixitGrid pest control — hard isolation child config.
 */
const HARD_SITE_URL = "https://fixitgrid-pestcontrol.pages.dev";
const HARD_CANONICAL_ORIGIN = "https://fixitgrid.com";
const HARD_NICHE_LABEL = "Pest Control";
const HARD_PHONE_E164 = "+15615550100";
const HARD_PHONE_DISPLAY = "+1 (561) 555-0100";
